...
function SmartBio() {
    ...
    const getPDF = () => {
        ...
        setTimeout(() => {
            html2canvas(document.querySelector('.container'), {
                ...
                let fullname =
                    user.personalInfo.name.first + user.personalInfo.name.last;
    ...
    const getPadding = () => {
        const padding = window
            .getComputedStyle(ContentDiv.current)
    ...
    useEffect(() => {
        if (userKey) {
            FetchUser(userKey, setUser, setLoading);
        }
    }, [userKey]);
                    ...
                    <>
                        ...
                        <div
                            ...
                            style={{
                                ...
                                '--primary-half': colorShade(
                                    theme.primary,
                                    110
                                ),
                                '--primary-light': colorShade(
                                    theme.primary,
                                    210
                                ),
                                '--border': colorShade(theme.primary, 190),
                                '--secondary': theme.secondary,
                                '--secondary-half': colorShade(
                                    theme.secondary,
                                    110
                                ),
                                '--secondary-light': colorShade(
                                    theme.secondary,
                                    210
                                ),
                            }}
                        >
                            ...
                            <div
                                className={
                                    SidebarActive ? 'overlay active' : 'overlay'
                                }
